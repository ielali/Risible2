...
public class MissingTemplate extends RuntimeException {
    public MissingTemplate() {
    }

    public MissingTemplate(String message) {
        super(message);
    }
    ...
    public MissingTemplate(Throwable cause) {
        super(cause);
    }
}
